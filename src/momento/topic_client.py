...
class TopicClient:
    ...
    def subscribe(
        ...
        Args:
            ...
            resume_at_topic_sequence_number (int): The topic sequence number to resume at. Omit or set to 0 to start at
                the latest messages.
            resume_at_topic_sequence_page (int): The topic sequence page to resume at. Omit or set to 0 to start at the
                latest page.
