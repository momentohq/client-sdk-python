...
`
    ...
    def sorted_set_put_element(
        ...
        *,
        ...
        """
        put_elements_response = self.sorted_set_put_elements(
    ...
    def sorted_set_put_elements(
        ...
        *,
        ...
        Returns:
            CacheSortedSetPutElementsResponse
        """
        return self._data_client.sorted_set_put_elements(cache_name, sorted_set_name, elements, ttl)
    ...
    def sorted_set_fetch_by_score(
        ...
        """
        return self._data_client.sorted_set_fetch_by_score(
    ...
    def sorted_set_fetch_by_rank(
        ...
        Returns:
            CacheSortedSetFetchResponse: The fetched sorted set data with associated metadata.
        """
        return self._data_client.sorted_set_fetch_by_rank(cache_name, sorted_set_name, start_rank, end_rank, sort_order)
    ...
    def sorted_set_get_score(
        ...
        """
        get_scores_response = self.sorted_set_get_scores(cache_name, sorted_set_name, [value])
    ...
    def sorted_set_get_scores(
        ...
        """
        return self._data_client.sorted_set_get_scores(cache_name, sorted_set_name, values)
