...
try:
    ...
    from momento.internal.synchronous._vector_index_client import _VectorIndexClient
...
class VectorIndexClient:
    ...
    def create_index(self, index_name: str, num_dimensions: int) -> CreateIndexResponse:
        ...
        """
        return self._control_client.create_index(index_name, num_dimensions)
    ...
    def upsert_item_batch(self, index_name: str, items: list[Item]) -> VectorIndexUpsertItemBatchResponse:
