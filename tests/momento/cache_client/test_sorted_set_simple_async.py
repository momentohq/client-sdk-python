...
async def _populate_scores(client_async, cache_name, sorted_set_name) -> dict:
...
async def test_sorted_set_fetch_by_score_fetch_all(client_async, cache_name, sorted_set_name):
...
async def test_sorted_set_fetch_by_score_fetch_all_descending(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
...
async def test_sorted_set_fetch_by_score_with_minmax(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
...
async def test_sorted_set_fetch_by_score_with_minmax_descending(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
...
async def test_sorted_set_fetch_by_score_fetch_all_with_offset(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
...
async def test_sorted_set_fetch_by_score_fetch_all_with_offset_descending(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
    resp = await client_async.sorted_set_fetch_by_score(
...
async def test_sorted_set_fetch_by_score_fetch_all_with_count(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
    resp = await client_async.sorted_set_fetch_by_score(cache_name, sorted_set_name, count=2)
    assert resp.value_list_string == [(k, v) for k, v in scores.items()][:2]


async def test_sorted_set_fetch_by_score_fetch_all_with_count_descending(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
    resp = await client_async.sorted_set_fetch_by_score(
...
async def test_sorted_set_fetch_by_score_fetch_all_with_offset_and_count(client_async, cache_name, sorted_set_name):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
...
async def test_sorted_set_fetch_by_score_fetch_all_with_offset_and_count_descending(
        client_async, cache_name, sorted_set_name
):
    scores = await _populate_scores(client_async, cache_name, sorted_set_name)
